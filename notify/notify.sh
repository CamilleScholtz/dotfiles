...
# Kill old scripts
exist=$(pgrep -f "bash /home/onodera/.scripts/notify/notify.sh" | wc -w)
if [[ $exist -ge 3 ]]; then
	pkill -fo "bash /home/onodera/.scripts/notify/notify.sh"
fi

# Get the notification text
text=$(cat /home/onodera/.scripts/notify/text)
