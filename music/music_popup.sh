...
feh --title music_arrow -N --zoom fill -g 18x1+52+1020 "$SCRIPTS/music/music_arrow.png" & disown
feh --title music_arrow -N --zoom fill -g 16x1+53+1021 "$SCRIPTS/music/music_arrow.png" & disown
feh --title music_arrow -N --zoom fill -g 14x1+54+1022 "$SCRIPTS/music/music_arrow.png" & disown
feh --title music_arrow -N --zoom fill -g 12x1+55+1023 "$SCRIPTS/music/music_arrow.png" & disown
feh --title music_arrow -N --zoom fill -g 10x1+56+1024 "$SCRIPTS/music/music_arrow.png" & disown
feh --title music_arrow -N --zoom fill -g 8x1+57+1025 "$SCRIPTS/music/music_arrow.png" & disown
feh --title music_arrow -N --zoom fill -g 6x1+58+1026 "$SCRIPTS/music/music_arrow.png" & disown
feh --title music_arrow -N --zoom fill -g 4x1+59+1027 "$SCRIPTS/music/music_arrow.png" & disown
feh --title music_arrow -N --zoom fill -g 2x1+60+1028 "$SCRIPTS/music/music_arrow.png" & disown
