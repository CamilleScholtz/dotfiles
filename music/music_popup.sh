...
# Spawn the popup
urxvt -name music_popup -geometry 50x9 -internalBorder 10 -hold -cursorUnderline -cursorColor $color -cursorColor2 $color -e watch -t -c sh ~/.scripts/music/music_popup_content.sh & disown
# Wait a bit and spawn the album art, it we don't wait the popup will overlap the album art
sleep 0.1
feh -g 128x128+49+877 -B black "~/Music/$path/cover."* & disown
